...
First, we need to fix the outstanding errors found with Google's Fontbakery tool that have been outlined in this issue: https://github.com/google/fonts/issues/2083
...
* **Polytonic Greek** - niche, but it has historic and liturgical usage
